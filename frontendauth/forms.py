...
class SignUpForm(UserCreationForm):
    ...
    user_type =forms.CharField(label='User Type', widget=forms.Select(choices=USER_TYPE),)


    class Meta:
        model = User
        fields = ('username', 'first_name', 'last_name', 'email', 'password1', 'password2','address','phone','photo','user_type' )